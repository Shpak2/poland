                ...
                <div class="banner-content">
                    ...
                    <div class="banner-body">
                        ...
                        <div class="banner-action">
                            <a href="<?php echo carbon_get_theme_option('banner_crb_link_2')?>" class="banner-action__btn">
                                <?php echo carbon_get_theme_option('banner_crb_link_1_name')?>
                            </a>
                            <a href="<?php echo carbon_get_theme_option('banner_crb_link_2')?>" class="banner-action__link">
